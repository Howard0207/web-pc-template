...
class PhotoPreview extends React.Component {
    ...
    beyondWindow = () => {
        ...
        } else if ((rotateDeg % 360 === -90 && iWidth > iHeight) || (rotateDeg % 360 === -270 && iWidth > iHeight)) {
        ...
        } else if ((rotateDeg % 360 === -90 && iHeight > iWidth) || (rotateDeg % 360 === -270 && iHeight > iWidth)) {
    ...
    render() {
        ...
        const { bigUrl, tool, figureEl, loadEl, imgAttr, imgParentStyle, imgs, increaseNum } = this.state;
